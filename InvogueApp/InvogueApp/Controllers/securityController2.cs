...
namespace Application.Controllers
{
    public class SecurityController : Controller
    {
        ...
        private IGenericFactory<Hr_PersonnelOfficial> _personeelOffcialFactory;
        ...
        public ActionResult Login(LogOnModel model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    _personeelOffcialFactory = new BLL.Factory.HRM.PersonnelInforFactory.PersonnelOfficialFactory();
                    ...
                    if (logInStatus.IsAllowed)
                    {
                        ...
                        var aCompanyUser = _personeelOffcialFactory.FindBy(x => x.PersonnelID == aSecurityUser.PersonnelId).FirstOrDefault();
