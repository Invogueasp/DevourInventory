...
namespace DAL.Helper
{
    public class CheckSessionData
    {
        ...
        {            
            ...
            {
                CheckSessionData aCheckSessionData = new CheckSessionData("", "PersonnelId");
                sessionData.Add(1, aCheckSessionData);
            }
            else
            {
                CheckSessionData aCheckSessionData = new CheckSessionData(Convert.ToString(HttpContext.Current.Session["LoginEmployee"].ToString()), "PersonnelId");
                sessionData.Add(1, aCheckSessionData);
            }
