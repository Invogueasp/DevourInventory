...
namespace BLL.Factory.Security
{
    ...
    public class UserFactory : GenericFactory<DevourInvEntities, SEC_UserInformation>
    {

    }

    public class UserPasswordFactory : GenericFactory<DevourInvEntities, SEC_Password>
    {

    }

    public class LoginStatusFactory : GenericFactory<DevourInvEntities, SEC_LoginStatus>
    {

    }

    public class QuestionFactory : GenericFactory<DevourInvEntities, SEC_SecurityQuestion>
    {

    }

    public class UserGroupFactory : GenericFactory<DevourInvEntities, SEC_UserGroup>
    {

    }

    public class UserActionMappingFactory : GenericFactory<DevourInvEntities, SEC_UserActionMapping>
    {

    }

    public class UiPageFactory : GenericFactory<DevourInvEntities, SEC_UIPage>
    {

    }


    public class ModuleFactory : GenericFactory<DevourInvEntities, SEC_UIModule>
    {

    }
    public class CompanyFactory : GenericFactory<DevourInvEntities, SET_Company>
    {
    ...
    {
        private DevourInvEntities context;
        ...
        private string tableSave = "Save Successful";
        private string tablePageName = "Page";
        Result _result = new Result();
        int userID = 1;
        public SecurityFactorys()
        {
            context = new DevourInvEntities();
        }
                ...
                if (tblUserInformation != null)
                {
                    ...
                    if (logInStatus != null)
                    {
                        ...
                        else
                        {
                            ...
                            var decryptPass = encription.Decrypt(tblPassword.NewPassword).Trim();
                            ...
                            {
                                {
                                    ...
                                    //list.Add("UserEmployee", tblUserInformation.PersonnelId.ToString());
        ...
        public Result SaveCustomerUser(UserModel user)
        {
            _result = new Result();
            sqlFactory = new SQLFactory();
            string tableName = "Save Customer As User";
            try
            {
                SqlCommand cmd = new SqlCommand("sp_SaveCustomerUser");
                ...
                cmd.Parameters.AddWithValue("@iCompanyID", user.CompanyID);
                cmd.Parameters.AddWithValue("@iBranchID", user.BranchID);
                cmd.Parameters.AddWithValue("@iFirstName", user.FirstName);
                cmd.Parameters.AddWithValue("@iMiddleName", user.MiddleName);
                cmd.Parameters.AddWithValue("@iLastName", user.LastName);
                cmd.Parameters.AddWithValue("@iUserName", user.UserName);
                cmd.Parameters.AddWithValue("@iGender", user.Gender);
                cmd.Parameters.AddWithValue("@iCountry", user.Country);
                cmd.Parameters.AddWithValue("@iCompanyName", user.CompanyName);
                cmd.Parameters.AddWithValue("@iHowDidYouKnow", user.HowDoyouKnow);
                cmd.Parameters.AddWithValue("@iBirthDay", user.BirthDate);
                cmd.Parameters.AddWithValue("@iAddress", user.Address);
                cmd.Parameters.AddWithValue("@iEMail", user.EMail);
                cmd.Parameters.AddWithValue("@iPhoneNo", user.PhoneNo);
                cmd.Parameters.AddWithValue("@iPasswordID", user.PasswordID);
                cmd.Parameters.AddWithValue("@iNewPassword", user.NewPassword);
                cmd.Parameters.AddWithValue("@iSecurityQuestionID", user.SecurityQuestionID);
                cmd.Parameters.AddWithValue("@iIsEMailVerified", user.IsEMailVerified);
                cmd.Parameters.AddWithValue("@iIsPhoneNoVerified", user.IsPhoneNoVerified);
                cmd.Parameters.AddWithValue("@iUserGroupID", user.UserGroupID);
                cmd.Parameters.AddWithValue("@iCustomerID", user.CustomerID);
                cmd.Parameters.AddWithValue("@iIsActive", user.IsActive);
                cmd.Parameters.AddWithValue("@iCreatedDate", user.CreatedDate);
                cmd.Parameters.AddWithValue("@iCreatedBy", user.CreatedBy);
                cmd.Parameters.AddWithValue("@iUpdatedDate", user.UpdatedDate);
                cmd.Parameters.AddWithValue("@iUpdatedBy", user.UpdateddBy);
        ...
        public Result UiPageSave(SEC_UIPage page)
        {
            ...
            int luserId = Convert.ToInt32(dictionary[3].Id == "" ? 0 : Convert.ToInt32(dictionary[3].Id));
            try
            {
                if (page.ID > 0)
                {
                    ...
                    if (_result.isSucess)
                    {
                        ...
                        foreach (var details in groupID)
                        {
                            ...
                            if (uiMapping == 0)
                            {
                                ...
                                userActionMapping.CreatedBy = luserId;
